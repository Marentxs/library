...
class Controller {
  constructor(library) {
    ...
    this.close.addEventListener("click", (event) => {
      ...
      message.innerHTML = "";
      titleInput.classList.remove("input-error", "input-success");
      authorInput.classList.remove("input-error", "input-success");
      pagesInput.classList.remove("input-error", "input-success");
    });
